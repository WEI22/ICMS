...
"")
        ...
        self.pest_image.setPixmap(QtGui.QPixmap(".\\src\\../Image/Home/bug.png"))
...
"}")
        ...
        self.location_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.chart.setStyleSheet("border: none; border-radius: 5px")
