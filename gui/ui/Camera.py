...
"")
        ...
        self.verticalLayout_3.addWidget(self.pest_detection_button)
        ...
        self.verticalLayout_3.addWidget(self.disease_detection_button)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\src\\img/camera/left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.up_button = QtWidgets.QPushButton(Dialog)
        self.up_button.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\src\\img/camera/up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.up_button.setIcon(icon1)
        self.up_button.setObjectName("up_button")
        self.verticalLayout.addWidget(self.up_button)
        self.horn_button = QtWidgets.QPushButton(Dialog)
        self.horn_button.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(".\\src\\img/camera/stop-button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.horn_button.setIcon(icon2)
        self.horn_button.setObjectName("horn_button")
        self.verticalLayout.addWidget(self.horn_button)
        self.down_button = QtWidgets.QPushButton(Dialog)
        self.down_button.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(".\\src\\img/camera/down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(".\\src\\img/camera/right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
